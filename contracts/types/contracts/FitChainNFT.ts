...
export interface FitChainNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface FitChainNFT extends BaseContract {
  connect(runner?: ContractRunner | null): FitChainNFT;
  waitForDeployment(): Promise<this>;

  interface: FitChainNFTInterface;
  ...
  mintBadge: TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
  ...
  filters: {
    ...
    "BadgeMinted(address,uint256)": TypedContractEvent<
      BadgeMintedEvent.InputTuple,
      BadgeMintedEvent.OutputTuple,
      BadgeMintedEvent.OutputObject
    >;
